...
namespace Batman 
{ //Constants for easy use(trig,angles etc.
	...
	public:
		...
		static double AngleToTarget(double xl, double yl,
			double x2, double y2);
		static double AngleToTarget(Vector3& source, Vector3& target);
		static double AngleToTarget(Vector2& source, Vector2& target);

		//get distance between two points 
		static double Distance(double xl, double yl, double zl,
			double x2, double y2, double z2);
		static double Distance(double xl, double yl,
			double x2, double y2);
		...
		static double DotProduct(double xl, double yl, double zl,
			double x2, double y2, double z2);
		static double DotProduct(double xl, double yl,
			double x2, double y2);
		...
		static Vector3 CrossProduct(double xl, double yl, double zl,
			double x2, double y2, double z2);
