...
namespace Batman
{
	...
	//copy constructor 
	Rect::Rect(const Rect& R) { Set(R); }
	//copy constructor 
	//windows RECT
	Rect::Rect(const RECT& R) { Set(R); }

	//constructor - set int values 
	Rect::Rect(int l, int t, int r, int b) { Set(l, r, t, b); }

	//constructor - set double values 
	Rect::Rect(double l, double t, double r, double b) { Set(l, t, r, b); }

	//assignment operator 
	Rect& Rect::operator=(const Rect& R) { Set(R); return *this; }
	...
	bool Rect::Contains(int x, int y) { return Contains((double)x, (double)y); }
